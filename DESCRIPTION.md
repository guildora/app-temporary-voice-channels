Voice Rooms automatically creates and manages temporary voice channels for your Discord server. When a member joins the lobby channel, a new voice channel is instantly created — and automatically cleaned up when everyone leaves.

## Features

- **Auto-creation** — joining the lobby channel instantly spawns a temporary voice room
